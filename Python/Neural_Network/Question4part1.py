# -*- coding: utf-8 -*-
"""
Created on Sun Apr 24 02:44:26 2022
...
print(learningrates[0],learningrates[1])
while(z<3):
    ...
    optimizer = torch.optim.SGD(model.parameters(), lr=learningrates[z],momentum=0)  
  ...
  # valid_accuracy =valid_accuracy.cpu()
    #training_loss = training_loss.cpu()
  # training_accuracy =training_accuracy.cpu()
    
# =============================================================================
#     best_test =np.array(best_test_acc)
...
# =============================================================================
#     best_test_acc =np.squeeze(best_test_acc)
#     valid_accuracy =np.squeeze(valid_accuracy)
#     training_loss = np.squeeze(training_loss)
#     training_accuracy =np.squeeze(training_accuracy)
# =============================================================================
